        ...
        for(int i=0;i<list.size();i++)
        {
            if(!list.get(i).equals(">"))
            {
                ...
                if(!flag)
                {
                    ...
                    int l=0;
                    String s1 = "";
                    BloomFilter[] bf = new BloomFilter[2];
                    ...
                    while(k<list2.size())
                    {
                        ...
                        BloomFilter[] bf2 = new BloomFilter[2];
                        bf2[0] = new BloomFilter();
                        bf2[1] = new BloomFilter();
                        bf2[0].add(String.valueOf(lx));
                        bf2[1].add(String.valueOf(ly));
                        rectangles[l].setbF(bf2);

                        bf[0].getBits().or(bf2[0].getBits());
                        bf[1].getBits().or(bf2[1].getBits());
...
//                    System.out.println(bf[0].getBits());
                    ...
                    while(k<list2.size())
                    {
                        ...
                        s += rectangles[l] + rectangles[l].getRectangleHash() + rectangles[l].getbF()[0].getBits().toString() + rectangles[l].getbF()[1].getBits().toString();
                        bf[0].getBits().or(rectangles[l].getbF()[0].getBits());
                        bf[1].getBits().or(rectangles[l].getbF()[1].getBits());
                        l++;
                        list2.remove(k);
                    }
                    Rectangle r = Rectangle.getUnionRectangle(rectangles);
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        String f = "C:\\Workspaces\\data\\d2\\rt2_11.txt";
        ...
        while ((line = reader.readLine()) != null) {
            ...
            bf[0] = new BloomFilter();
            bf[1] = new BloomFilter();
            bf[0].add(String.valueOf(lx));
            bf[1].add(String.valueOf(ly));
            rectangle.setbF(bf);
